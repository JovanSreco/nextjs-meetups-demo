...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://JovanSreco:mongoDB1234@cluster0.oohkwxr.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
